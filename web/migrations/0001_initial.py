# Generated by Django 3.2 on 2024-06-20 15:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('active', models.SmallIntegerField(choices=[(1, '激活'), (2, '删除')], default=1, verbose_name='状态')),
                ('charge_type', models.SmallIntegerField(choices=[(1, '充值'), (2, '扣款'), (3, '创建订单'), (4, '删除订单'), (5, '撤单')], default=1, verbose_name='类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oid', models.CharField(db_index=True, max_length=64, verbose_name='订单号')),
